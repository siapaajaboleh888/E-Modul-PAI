-- ========================================================================
-- INSTALL SEMUA TABEL BARU E-MODUL PAI - SATU KALI JALAN
-- ========================================================================
-- Copy semua isi file ini dan paste ke TablePlus, lalu klik RUN
-- ========================================================================
...
CREATE TABLE IF NOT EXISTS pbl_scenarios (
  ...
  CONSTRAINT fk_pbl_creator FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS transformative_assessments (
  ...
  CONSTRAINT fk_trans_assess_student FOREIGN KEY (student_id) REFERENCES users(id) ON DELETE CASCADE,
  CONSTRAINT fk_trans_assess_value FOREIGN KEY (value_id) REFERENCES transformative_values(id) ON DELETE CASCADE,
  CONSTRAINT fk_trans_assess_assessor FOREIGN KEY (assessed_by) REFERENCES users(id) ON DELETE SET NULL,
...
-- 7. UPDATE TABEL TASK_SUBMISSIONS (tambah kolom graded_at)
ALTER TABLE task_submissions ADD COLUMN IF NOT EXISTS graded_at DATETIME;
...
-- 10. VERIFIKASI - Tampilkan semua tabel
SHOW TABLES;

-- SELESAI! Database Anda sekarang sudah lengkap dengan 6 tabel baru!
